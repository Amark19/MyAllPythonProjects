...
def gameloop():
    player=pygame.image.load('G:\PROJECTS_AMAR\PYTHON\imgs\gallery\player.png')
    bg=pygame.image.load('G:\PROJECTS_AMAR\PYTHON\imgs\gallery\highway.png')
    bg1=pygame.image.load('G:\PROJECTS_AMAR\PYTHON\imgs\gallery\highway.png')
    e2=pygame.image.load('G:\PROJECTS_AMAR\PYTHON\imgs\gallery\enemy2.jpg')
    e1=pygame.image.load('G:\PROJECTS_AMAR\PYTHON\imgs\gallery\enemy1.jpg')
    e3=pygame.image.load('G:\PROJECTS_AMAR\PYTHON\imgs\gallery\enemy3.jpeg')
    gameover=False
    black=[0,0,0]
    run=True
    vel=8
    ...
    while run:
        if gameover:
            win.fill(black)
            text_screen("Game Over! Press Enter To Continue", [255,0,0], 50, 250)
